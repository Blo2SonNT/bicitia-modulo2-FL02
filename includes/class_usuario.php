...
class Usuario extends Conexion_pp
{
    ...
    function actualiza_usuario($id, $nombre, $apellido, $correo, $fec_nac, $genero, $tyc)
    {
        $this->nombre_user = $nombre;
        $this->apellido_user = $apellido;
        $this->correo_user = $correo;
        ...
        $query_update = "UPDATE tb_usuarios SET nombre = ?, apellido = ?, correo = ?, fec_nac = ?, genero = ?, tyc = ? WHERE id_usuario = $id";
